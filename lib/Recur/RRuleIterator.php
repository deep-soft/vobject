...
class RRuleIterator implements \Iterator
{
     ...
     */
    protected function nextHourly(int $amount = 1): void
    {
     ...
     */
    protected function nextDaily(int $amount = 1): void
    {
     ...
     */
    protected function nextWeekly(int $amount = 1): void
    {
        if (!$this->byHour && !$this->byDay) {
     ...
     * @throws \Exception
     */
    protected function nextMonthly(int $amount = 1): void
    {
     ...
     */
    protected function nextYearly(int $amount = 1): void
    {
